...
class main(Tkinter.Tk):
    ...
    def creating_background_(self):
        self.image = Tkinter.PhotoImage(file='D:\picture\images\\18.png')
    ...
    def creating_sticks(self):
        self.sticks = []
        for i in range(3):
            store = self.canvas.create_line(self.x, self.y, self.x+self.length, self.y+self.length, width=8, fill='red')
